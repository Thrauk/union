            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  ...
                  if (state.fullUser.isOpenForCollaborations) const ChipWithText(label: 'Open for collaborations'),
                  const SizedBox(
                    height: 8,
                  ),
                  Row(
                    ...
                    children: <Widget>[
                      Text(state.fullUser.location ?? 'No location', style: AppStyles.textStyleBody),
                      const Text(
                        ' • ',
                        style: TextStyle(
