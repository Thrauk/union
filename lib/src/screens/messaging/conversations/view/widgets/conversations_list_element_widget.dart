...
class ConversationsListElementWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ElementBloc>(create: (_) => ElementBloc(uid: uid),
        ...
        return GestureDetector(
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Row(
                children: <Widget>[
                  Avatar(photo: state.user.photo, avatarSize: 30,),
                  const SizedBox(width: 8,),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text(state.user.displayName ?? '', style: AppStyles.textStyleBody,),
                      Text(conversation.lastMessage!.message, style: AppStyles.textStyleBodySmall,),
                    ],
                  )
                ],
              ),
